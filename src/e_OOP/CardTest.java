...
class Card{
	//1. 카드의 너비를 저장 할 수 있는 클래스변수 width 선언하고 100의 값으로 초기화 하세요
	static int width = 100;
	//2. 카드의 높이를 저장 할 수 있는 클래스변수 height 선언하고 250의 값으로 초기화 하세요
	static int height = 250;
	//3. 카드의 종류를 저장할수 있는 인스턴스변수 kind를 선언해주세요
	String kind;
	//4. 카드의 번호를 저장할수 있는 인스턴스변수 number를 선언해주세요1~13
	int number;
