	...
	public static void main(String[] args) {
		  ...
		  2) 핵심 interface
		    ...
		    - Map<key,value>    
		      ...
		      : key는 중복을 비허용한다
		        value는 중복을 허용한다.
		        ex) 우편번호, 지역번호
		      : HashMap, HashTable, TreeMap(순서), Properties
		...
		2. List
		  ...
		  - LinkedList 
		    ...
		    : 자신과 연결된 다음 요소에 대한 주소값과 데이터로 이루어짐(몸통,꼬리)    
		      
		  - DoubleLinkedList 
		    : 자신과 연결된 이전요소와 다음요소에 대한 주소값과 데이터로 이루어짐(머리,몸통,꼬리)
		...
		6. Map
		  ...
		  - Map의 특징은 key, value를 묶어 하나의 데이터로 저장한다.
		  - Map<Object,Object>타입이지만 key의 경우 String으로 통일해서 많이 사용된다.
		  - key는 유일해야 한다.//아이디
